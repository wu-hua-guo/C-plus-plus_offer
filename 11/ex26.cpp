...
{
    if(lhs - rhs > -0.0000001 && lhs - rhs < 0000001)
        return true;
    return false;
}
...
bool DoesTree1HaveTree2_2(BinaryTreeNode* pRoot1, BinaryTreeNode* pRoot2)
{
    if(pRoot2 == nullptr)
        return true;
    if(pRoot1 == nullptr)
...
bool DoesTree1HaveTree2_1(BinaryTreeNode* pRoot1, BinaryTreeNode* pRoot2);
...
bool HasSubtree_1(BinaryTreeNode* pRoot1, BinaryTreeNode* pRoot2)
{
    bool result = false;
...
bool Equal_1(double num1, double num2)
{
