...
BinaryTreeNode* Convert_1(BinaryTreeNode* pRootOfTree)
{
...
void ConvertNode_1(BinaryTreeNode* pNode, BinaryTreeNode** pLastNodeInList)
{
    if(pNode == nullptr)
        return;
...
void PrintDoubleLinkedList(BinaryTreeNode* pHeadOfList)
{
    ...
    cout << "from left to right are:" <<endl;
    for(;pNode!=nullptr;pNode = pNode->m_pRight)
    {
        cout <<pNode->m_nValue<<" ";
        if(pNode->m_pRight==nullptr)
            break;
    ...
    cout << "from right to left are:" <<endl;
    for(;pNode !=nullptr;pNode = pNode->m_pLeft)
    {
        cout <<pNode->m_nValue<<" ";
        if(pNode->m_pLeft == nullptr)
            break;
...
void PrintDoubleLinkedList_1(BinaryTreeNode* pHeadOfList)
{
    BinaryTreeNode* pNode = pHeadOfList;
