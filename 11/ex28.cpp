...
bool isSymmetrical_2(BinaryTreeNode* pRoot1, BinaryTreeNode* pRoot2)
{
    if(pRoot1 == nullptr && pRoot2 == nullptr)
        return true;
    ...
    return isSymmetrical_2(pRoot1->m_pLeft,pRoot2->m_pRight)&&
            isSymmetrical_2(pRoot1->m_pRight,pRoot2->m_pLeft);
}
bool isSymmetrical(BinaryTreeNode* pRoot1, BinaryTreeNode* pRoot2)
{
    if(pRoot1 == nullptr && pRoot2 == nullptr)
